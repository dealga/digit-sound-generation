...
def train(x_train, learning_rate, batch_size, epochs):
    ...
    variationalautoencoder.compile(learning_rate)
    variationalautoencoder.train(x_train, batch_size, epochs)
...
if __name__ == "__main__":
    ...
    variationalautoencoder = train(x_train[:500],LEARNING_RATE, BATCH_SIZE, EPOCHS)


    variationalautoencoder.save("model") #save the model to disk

    variationalautoencoder2 = VAE.load("model") #load the model from disk
    variationalautoencoder2.summary() #print the model summary
